      ...
      <div className={`mt-4 transition-all duration-300 overflow-hidden ${isCompsOpen ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="border-t pt-4">
          ...
          <div className="mb-6 p-4 bg-money-green/10 rounded-lg">
            <h4 className="font-bold text-space-cadet mb-2">Why $724,999 is Excellent Value</h4>
            <p className="text-sm text-gray-600 mb-2">
              At <span className="font-semibold text-money-green">$183.49/sq ft</span>, this property offers exceptional value compared to recent sales ($195-$230/sq ft range).
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-money-green/20 p-3 rounded-lg border-2 border-money-green">
                  <div className="grid grid-cols-4 gap-2 text-xs">
                    ...
                    <div>
                      <span className="font-semibold text-money-green">$724,999</span>
                      <p className="text-gray-600">3,951 sq ft</p>
                    </div>
                    <div>
                      <span className="font-semibold text-money-green">$183.49/sf</span>
